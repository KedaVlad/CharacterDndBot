...
public interface ButtonName1 {
	...
	public final static String ROLLS_B = "ROLLS";
	public final static String CREATE_B = "CREATE";
	public final static String DELETE_B = "DELETE";
	public final static String DOWNLOAD_B = "DOWNLOAD";
	public final static String MENU_B = "Menu";
	public final static String RETURN_TO_MENU = "RETURN TO MENU";
	public final static String CARRYING_STUFF_B = "PREPEARE";
	public final static String FEATURE_B = "FEATURES";
	...
	public final static String REST_B = "REST";
	public final static String ELSE_B = "ELSE";
	public final static String WEAPON_B = "WEAPON";
	public final static String AMNUNITION_B = "AMNUNITION";
	public final static String TOOL_B = "TOOL";
